...
<body>
    ...
    <main role="main" class="main">
        <div class="jumbotron text-center mb-0">
            <h1 class="display-3 font-weight-normal text-muted">Manage Categories</h1>
        </div>
                ...
                <table class='table table-striped table-bordered'>
                    ...
                    <tbody>
                        ...
                        foreach ($categories as $category) :
                            ...
                            <td>
                                <a class="btn btn-danger" href="asset/delete.php?type=category&id=<?= $category['category_id'] ?> ">
