...
$stmt = $conn->prepare("SELECT distinct author_id, author_fullname FROM `author` INNER JOIN `users` on  author.id_user = users.id WHERE users.id = :userId");
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 mb-4">
                    <!-- Form -->
                    <form action="asset/insert.php?type=article" method="POST" enctype="multipart/form-data">
                        ...
                        <input class="custom-select" name="arAuthor" id="arAuthor" value="<?= $authors['author_id'] ?>" hidden>

                        <!--<div class="form-group">
                            <input type="hidden" name="arAuthor" id="arAuthor" value="<?/*= $_SESSION["id"] */?>">
                        </div>-->
                        <!--
                        <div class="form-group">
